...
const UserProfile = ({navigation, route}) => {
    ...
    return (
        ...
        <View style={styles.borders}>
            <View style={[styles.borders, {flexDirection: 'row'}, {alignItems: 'center'}]}>
                <Image style={[{margin: 10}, { width: 100, height: 100 }]}
                ...
                <View style={{flexDirection: 'column'}}>
                    ...
                    <TextInput 
                    value={route.params.userInfo[0].lastName}/>
                    
                    <TextInput 
                    value={route.params.userInfo[0].bio}/>
                </View>
            ...
            <View style={[{margin: 20, justifyContent: 'flex-end', alignItems: 'flex-end'}]}>
                <Pressable
